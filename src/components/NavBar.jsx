      ...
      <div className="container-lg">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav mx-auto">
            ...
            <li className="nav-item">
              <a href="/TomasFernandezValdes_ SoftwareDev_ENG2025.pdf" download="TomasFernandezValdes_SoftwareDev_ENG2025.pdf" className="nav-link d-lg-none">Download CV</a>
            </li>
          </ul>
          ...
          <a href="/TomasFernandezValdes_ SoftwareDev_ENG2025.pdf" download="TomaFernandezValdes_SoftwareDev_ENG2025.pdf" className="btn btn-outline-dark d-none d-lg-block">Download CV</a>
        </div>
      </div>
    </nav>
  )
