      ...
      <div className="container-lg">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav mx-auto">
            ...
            <li className="nav-item">
              <a href="TomásFernándezValdés_ Frontend_ENG2026.pdf" download="TomásFernándezValdés_ Frontend_ENG2026.pdf" className="nav-link d-lg-none">Download CV</a>
            </li>
          </ul>
          ...
          <a href="/TomásFernándezValdés_ Frontend_ENG2026.pdf" download="TomásFernándezValdés_ Frontend_ENG2026.pdf" className="btn btn-outline-dark d-none d-lg-block">Download CV</a>
        </div>
      </div>
    </nav>
  )
