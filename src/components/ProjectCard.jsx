...
export default function ProjectCard({
  ...
  return (
    <div
      className={`col-lg-4 col-sm-6 mt-4 reveal ${isVisible ? "active" : ""}`}
      ref={cardRef}
    >
      <div
        className={`card ${category === "game" ? "game-project-card-container" : "project-card-container"}`}
      >
